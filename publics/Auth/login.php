...
if(isset($_POST['login'])){
    ...
    if($num_err==0){
        ...
        $cust=$stm->fetch(PDO::FETCH_ASSOC);
        // $custs=$stm->fetchAll();
...
if(isset($_POST['resetpwd'])){
    ...
    if(empty($errors["email"])){
        ...
        $stm=$conn->prepare("SELECT cust_email from customer where cust_email=:cust_email");
        $stm->bindParam(":cust_email", $email);
        $stm->execute();
        ...
        if(!$cust){
            ...
            $subject="Email Verification";
            $data = [
                        'message'     => 'You forgot your password? Please use the verification code below to verify your email and proceed to reset your email:',
                        'token' => $generated_token[0],
...
<body>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="POST">
            ...
            <div class="form-container">
                ...
                <div class="error"><?php echo $errors["email_not_found"] ?></div>  
                <div class="input-group input-wrapper mb-3">
                    ...
                    <input type="email" class="form-control" name="email" placeholder="Email" aria-label="Email" aria-describedby="email_icon">    
                </div>
                ...
                <div class="reset">
                    ...
                    <div><input type="submit" value="Forgot password?" name="resetpwd" id="resetpwd"></div>
                </div>
                <div class="submitbut">
